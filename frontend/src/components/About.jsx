      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <Card className="bg-gray-900/50 border-gray-700/50 backdrop-blur-sm hover:bg-gray-900/70 transition-all duration-500 transform hover:scale-105 group animate-slide-in-left">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center mb-4">
                <Code className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400 mr-3" />
                <h3 className="text-lg sm:text-xl font-semibold group-hover:text-purple-400 transition-colors">
                  Technical Skills
                </h3>
              </div>
                ...
                {skills.map((skill, index) => (
                  <div key={skill.name} className="animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-1.5 sm:h-2 overflow-hidden">
                      <div
                        className="bg-gradient-to-r from-purple-500 to-blue-500 h-1.5 sm:h-2 rounded-full transition-all duration-2000 animate-skill-bar shadow-lg shadow-purple-500/20"
          ...
          >
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center mb-4">
                <Rocket className="w-5 h-5 sm:w-6 sm:h-6 text-blue-400 mr-3" />
                <h3 className="text-lg sm:text-xl font-semibold group-hover:text-blue-400 transition-colors">Experience</h3>
              </div>
              <div className="space-y-3 sm:space-y-4">
                <div className="border-l-2 border-purple-500 pl-3 sm:pl-4 hover:border-purple-400 transition-colors">
                ...
                <div className="border-l-2 border-blue-500 pl-3 sm:pl-4 hover:border-blue-400 transition-colors">
          ...
          <Card
            className="bg-gray-900/50 border-gray-700/50 backdrop-blur-sm hover:bg-gray-900/70 transition-all duration-500 transform hover:scale-105 group animate-slide-in-right md:col-span-2 lg:col-span-1"
            style={{ animationDelay: "0.4s" }}
          >
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center mb-4">
                <Trophy className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400 mr-3" />
                <h3 className="text-lg sm:text-xl font-semibold group-hover:text-yellow-400 transition-colors">Achievements</h3>
              </div>
              <div className="grid grid-cols-3 gap-3 sm:gap-4">
                <div className="text-center group-hover:scale-110 transition-transform">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-400 animate-counter">2+</div>
                  <div className="text-gray-400 text-xs sm:text-sm">Major Projects</div>
                </div>
                <div className="text-center group-hover:scale-110 transition-transform">
                  <div className="text-2xl sm:text-3xl font-bold text-blue-400 animate-counter">10</div>
                  <div className="text-gray-400 text-xs sm:text-sm">CGPA Achieved</div>
                </div>
                <div className="text-center group-hover:scale-110 transition-transform">
                  <div className="text-2xl sm:text-3xl font-bold text-green-400 animate-counter">6+</div>
